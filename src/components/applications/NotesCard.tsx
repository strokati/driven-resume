        ...
        {notes.length === 0 ? (
          ...
          <div className="max-h-96 overflow-y-auto -mx-1 px-1">
            <ul className="divide-y divide-border">
              {notes.map((note) => (
                <li key={note.id} className="group py-2 first:pt-0 last:pb-0">
                  {editingId === note.id ? (
                    ...
                    <div className="flex items-start gap-3">
                      <span className="text-[0.65rem] text-muted-foreground w-14 shrink-0 pt-0.5 tabular-nums">
        ...
        <div className="space-y-2 pt-1">
          ...
          <div className="flex items-center justify-between">
            <span
              className={cn(
                'text-xs',
                draftRemaining < 0 ? 'text-destructive' : 'text-muted-foreground'
              )}
            >
